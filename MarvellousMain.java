...
class MarvellousLogin extends Template implements ActionListener, Runnable
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            ...
            if(value1.equals("FilesAdmin") && value2.equals("FilesAdmin"))
            {
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number of attempts finishied","File Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                      this.dispose();
                      System.exit(0);
                }
